...
const questions: Question[] = [
  ...
  },
  {
    ...
    imageDescription: "Imagen de un libro abierto con las páginas formando un ángulo llano",
    options: ["Ángulo agudo", "Ángulo recto", "Ángulo obtuso", "Ángulo llano"],
  ...
  },
  {
    ...
    imageDescription: "Imagen de una silla con el asiento formando un ángulo llano",
    options: ["Ángulo agudo", "Ángulo recto", "Ángulo obtuso", "Ángulo llano"],
    correctAnswer: "Ángulo llano"
  },
];
